                    ...
                    <div class="slider-church">
                        <ul id="lightSlider">
                            <li data-thumb="<c:url value="/resources/img/chanhtoa1.jpg"/>">
                                <div class="set-size-img"><img src="<c:url value="/resources/img/chanhtoa1.jpg"/>" /></div>
                            </li>
                            <li data-thumb="<c:url value="/resources/img/chanhtoa2.jpg"/>">
                                <div class="set-size-img"><img src="<c:url value="/resources/img/chanhtoa2.jpg"/>" /></div>
                            </li>
                            <li data-thumb="<c:url value="/resources/img/chanhtoa3.jpg"/>">
                                <div class="set-size-img"><img src="<c:url value="/resources/img/chanhtoa3.jpg"/>" /></div>
                            </li>
                            <li data-thumb="<c:url value="/resources/img/chanhtoa4.jpg"/>">
                                <div class="set-size-img"><img src="<c:url value="/resources/img/chanhtoa4.jpg"/>" /></div>
                            </li>
                            <li data-thumb="<c:url value="/resources/img/chanhtoa5.jpg"/>">
                                <div class="set-size-img"><img src="<c:url value="/resources/img/chanhtoa5.jpg"/>" /></div>
                            </li>
                            <li data-thumb="<c:url value="/resources/img/chanhtoa6.jpg"/>">
                                <div class="set-size-img"><img src="<c:url value="/resources/img/chanhtoa6.jpg"/>" /></div>
                            </li>
                            <li data-thumb="<c:url value="/resources/img/chanhtoa7.JPG"/>">
                                <div class="set-size-img"><img src="<c:url value="/resources/img/chanhtoa7.JPG"/>" /></div>
                            </li>
                            <li data-thumb="<c:url value="/resources/img/chanhtoa8.jpg"/>">
                                <div class="set-size-img"><img src="<c:url value="/resources/img/chanhtoa8.jpg"/>" /></div>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="title-home-page">
                        <h2 class="text-center"><b>Nhà thờ Chánh Tòa Đà Nẵng</b></h2>
                    </div>
                </div>
                <div class="col-md-12" style="line-height: 39px;">
                    <div class="col-md-3">
                        <div class="row">
                            ...
                            <p><b>Website:</b></p>
                            <p><b>Lễ ngày thường:</b></p>
                            <p><b>Lễ chủ nhật:</b></p>
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="row">
                            <p>156 Trần Phú, Thành Phố Đà Nẵng , Việt Nam</p>
                            <p>Đà Nẵng</p>
                            <p>Đà Nẵng</p>
                            <p>Thánh Tâm Chúa Giêsu</p>
                            <p>Linh Mục .Phaolo Maria Trần Quốc Việt</p>
                            <p>0511 382 5285</p>
                            <p>http://www.giaoxuchinhtoadanang.org</p>
                            <p>5:00 - 17:00</p>
                            <p>5:15 - 8:00  10:00 - 15:00  17:00 - 18:30</p>
                        </div>
                    </div>
                </div>
            </div>
