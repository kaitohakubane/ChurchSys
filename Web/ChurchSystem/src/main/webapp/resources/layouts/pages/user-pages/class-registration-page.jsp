                        ...
                        <div class="panel-body" style="padding: 15px 0">
                            ...
                            <div class="col-md-8 form-group has-success">
                                <div class="input-group">
                                    <input type="text" class="form-control" disabled="disabled" value="${item.eventName}"><br/>
                            ...
                            <div class="col-md-8 form-group has-success">
                                <div class="input-group">
                                    <input type="text" class="form-control" disabled="disabled" value="${item.startDate}"><br/>
