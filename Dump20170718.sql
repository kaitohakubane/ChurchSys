...
CREATE TABLE `ability` (
  ...
  KEY `subId` (`subId`),
  CONSTRAINT `ability_ibfk_1` FOREIGN KEY (`conductorId`) REFERENCES `user` (`userId`),
  CONSTRAINT `ability_ibfk_2` FOREIGN KEY (`subId`) REFERENCES `subject` (`subId`)
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `church` (
  `churchId` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `church` VALUES (1,'Nhà Thờ Hòa Khánh',108.152014,16.073826,'0123456789',' 50 Nguyễn Lương Bằng, Hòa Khánh Bắc, Liên Chiểu, Đà Nẵng','hoakhanh@gmail.com','04:00:00','21:00:00',NULL,'abc','',''),(2,'Nhà Thờ Hòa Minh',108.171837,16.070841,'0123456789','Phú Lộc 18, Hòa Minh, Liên Chiểu, Đà Nẵng','hoaminh@gmail.com','04:00:00','21:00:00',NULL,'xyz','J.Fla Show,Hoang Thuc Linh','MhQKe-aERsU,yDN_DMCzHLc'),(3,'Nhà Thờ Chánh Tòa Đà Nẵng',108.223317,16.066979,'0123456789','156 Trần Phú, Hải Châu 1, Q. Hải Châu, Đà Nẵng','ctdn@gmail.com','04:00:00','21:00:00',NULL,'xyz','','');
...
CREATE TABLE `contribution` (
  `contributeId` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `userId` (`userId`),
  KEY `postId` (`postId`),
  CONSTRAINT `contribution_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`),
  CONSTRAINT `contribution_ibfk_2` FOREIGN KEY (`postId`) REFERENCES `post` (`postId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `event` (
  ...
  `isRegistered` bit(1) DEFAULT NULL,
  PRIMARY KEY (`eventId`),
  KEY `subId` (`subId`),
  KEY `churchId` (`churchId`),
  KEY `typeId` (`typeId`),
  CONSTRAINT `event_ibfk_1` FOREIGN KEY (`subId`) REFERENCES `subject` (`subId`),
  CONSTRAINT `event_ibfk_2` FOREIGN KEY (`churchId`) REFERENCES `church` (`churchId`),
  CONSTRAINT `event_ibfk_3` FOREIGN KEY (`typeId`) REFERENCES `type` (`typeId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `inclusion` (
  `inclusionId` int(11) NOT NULL AUTO_INCREMENT,
  `slotId` int(11) DEFAULT NULL,
  `slotHourId` int(11) DEFAULT NULL,
  PRIMARY KEY (`inclusionId`),
  KEY `slotId` (`slotId`),
  KEY `slotHourId` (`slotHourId`),
  CONSTRAINT `inclusion_ibfk_1` FOREIGN KEY (`slotId`) REFERENCES `slot` (`slotId`),
  CONSTRAINT `inclusion_ibfk_2` FOREIGN KEY (`slotHourId`) REFERENCES `slothour` (`slotHourId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `interaction` (
  ...
  KEY `churchId` (`churchId`),
  KEY `userId` (`userId`),
  CONSTRAINT `interaction_ibfk_1` FOREIGN KEY (`churchId`) REFERENCES `church` (`churchId`),
  CONSTRAINT `interaction_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`)
...
CREATE TABLE `post` (
  ...
  `isContribute` bit(1) DEFAULT NULL,
  PRIMARY KEY (`postId`),
  KEY `conductorId` (`conductorId`),
  CONSTRAINT `post_ibfk_1` FOREIGN KEY (`conductorId`) REFERENCES `user` (`userId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `question` (
  ...
  `userId` int(11) DEFAULT NULL,
  `information` varchar(255) DEFAULT NULL,
  `quesStatus` varchar(255) DEFAULT NULL,
  `subId` int(11) DEFAULT NULL,
  PRIMARY KEY (`quesId`),
  KEY `subId` (`subId`),
  KEY `userId` (`userId`),
  ...
  CONSTRAINT `question_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`),
  CONSTRAINT `question_ibfk_3` FOREIGN KEY (`conductorId`) REFERENCES `user` (`userId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `registration` (
  `regisId` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `registration_ibfk_2` FOREIGN KEY (`subId`) REFERENCES `subject` (`subId`),
  CONSTRAINT `registration_ibfk_3` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`),
  CONSTRAINT `registration_ibfk_4` FOREIGN KEY (`churchId`) REFERENCES `church` (`churchId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `room` (
  ...
  PRIMARY KEY (`roomId`),
  KEY `churchId` (`churchId`),
  CONSTRAINT `room_ibfk_1` FOREIGN KEY (`churchId`) REFERENCES `church` (`churchId`)
...
--
-- Table structure for table `roomcapable`
--

DROP TABLE IF EXISTS `roomcapable`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `roomcapable` (
  `roomCapId` int(11) NOT NULL AUTO_INCREMENT,
  `roomId` int(11) DEFAULT NULL,
  `subId` int(11) DEFAULT NULL,
  PRIMARY KEY (`roomCapId`),
  KEY `subId` (`subId`),
  KEY `roomId` (`roomId`),
  CONSTRAINT `roomcapable_ibfk_1` FOREIGN KEY (`subId`) REFERENCES `subject` (`subId`),
  CONSTRAINT `roomcapable_ibfk_2` FOREIGN KEY (`roomId`) REFERENCES `room` (`roomId`)
...
CREATE TABLE `slot` (
  ...
  `streamLink` varchar(50) DEFAULT NULL,
  `streamCode` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`slotId`),
  KEY `eventId` (`eventId`),
  KEY `roomId` (`roomId`),
  KEY `conductorId` (`conductorId`),
  CONSTRAINT `slot_ibfk_1` FOREIGN KEY (`eventId`) REFERENCES `event` (`eventId`),
  CONSTRAINT `slot_ibfk_2` FOREIGN KEY (`roomId`) REFERENCES `room` (`roomId`),
  CONSTRAINT `slot_ibfk_3` FOREIGN KEY (`conductorId`) REFERENCES `user` (`userId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `slothour`
--

DROP TABLE IF EXISTS `slothour`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `slothour` (
  `slotHourId` int(11) NOT NULL,
...
CREATE TABLE `subject` (
  ...
  CONSTRAINT `subject_ibfk_1` FOREIGN KEY (`categoryId`) REFERENCES `category` (`categoryId`)
...
-- Dump completed on 2017-07-18 16:25:00
